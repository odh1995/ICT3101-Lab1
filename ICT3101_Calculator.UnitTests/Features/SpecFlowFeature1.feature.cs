...
#line hidden
#line 15
  testRunner.When(string.Format("I have entered \"{0}\" and \"{1}\" into the calculator and press add II", value1, value2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 16
  testRunner.Then(string.Format("the result should be \"{0}\" II", value3), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
